...
const WeatherContanier = ({ city }: Props) => {
  ...
  return (
    <div className="flex mt-24 mx-4 justify-between -z-20">
      <div className="bg-white/30 backdrop-blur-xl text-black w-fit rounded-xl p-8 min-w-[30rem]">
        {weather && (
          <>
      ...
      <div className="bg-white/30 backdrop-blur-xl text-black w-fit rounded-xl p-8 min-w-[30rem] text-end ">
